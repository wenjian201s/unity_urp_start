...
public class ScreenSpaceReflectionFeature_ssr: ScriptableRendererFeature
{
    [System.Serializable]
    ...
    private ScreenSpaceReflectionPass_ssr m_ScreenSpaceReflectionPass;
    ...
    {
        m_ScreenSpaceReflectionPass = new ScreenSpaceReflectionPass_ssr();
